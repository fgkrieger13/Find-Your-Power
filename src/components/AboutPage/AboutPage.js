...
const AboutPage = () => (
  <div>
    <div className="about-container">
      <img className="about-heading-image" src="/zigzagheading.png" />
      <h1 className="about-title">
        About Us
      </h1>
      <div className="about-statment-container">
        <h4>
      ...
      <div className="about-purpose-statment-container">
        <h4>
      ...
      <h2 className="ethics-heading">Ethics</h2>
      <div className="about-ethics-statment-container">
        <h4>
        ...
        <ul>
          ...
          We aim to support women in their personal and professional growth and to build a community of amazing women that share these
        ...
        <ul>
          ...
          <h4>By signing up to use this site, I agree to all of the above.</h4>
        </h4>
      </div>
      <h2 className="payment-heading">Payment</h2>
      <div className="about-payment-statment-container">
        <h4>
